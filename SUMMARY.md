...
* [Configure edeXa Node](how-to/configure-edexa-node/README.md)
  * [Consensus protocols](how-to/configure-edexa-node/consensus-protocols/README.md)
    * [Configure IBFT 2.0 consensus](how-to/configure-edexa-node/consensus-protocols/configure-ibft-2.0-consensus.md)
    * [Add and remove validators without voting](how-to/configure-edexa-node/consensus-protocols/add-and-remove-validators-without-voting.md)
  * [Configure free gas networks](how-to/configure-edexa-node/configure-free-gas-networks.md)
  * [Configure bootnodes](how-to/configure-edexa-node/configure-bootnodes.md)
  * [Validators](how-to/configure-edexa-node/validators.md)
  * [TLS](how-to/configure-edexa-node/tls/README.md)
    * [Configure client and server TLS](how-to/configure-edexa-node/tls/configure-client-and-server-tls.md)
    * [Configure P2P TLS](how-to/configure-edexa-node/tls/configure-p2p-tls.md)
  * [Block proposal permissioning](how-to/configure-edexa-node/block-proposal-permissioning.md)
  * [Configure alternative elliptic curves](how-to/configure-edexa-node/configure-alternative-elliptic-curves.md)
